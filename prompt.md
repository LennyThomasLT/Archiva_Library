...
- ยืม isbn = 103 payment = cash _(ควร error เพราะ หนังสือเป็น premium เเต่สมาชิกไม่ได้เป็น member)_
...
- Login bob 1234\
- Upgrade member\
- ยืม 103 cash\ _(ควร error เพราะ เนื่องจาก Alice ยืมไปก่อนแล้ว )_
- จอง 103 cash\
- Logout
...
- Upgrade member\
- จอง 103 qr
- ดูคิวทั้งหมดของหนังสือ 103 (ควรได้ Alice, Lenny, Ton)
...
- ลบหนังสือ 105\
- ขอดูหนังสือทั้งหมด\
- ลบหนังสือ 103 _( mark ว่าหนังสือถูกลบ แล้วพอคนคืนก็ยืมไม่ได้)_
